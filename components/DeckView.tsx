  ...
  return (
    <div>
      ...
      <div className="flex justify-center gap-2 my-5">
        <Button text="Precedent" action={handlePreviousFlashcard} bgColor='dark' textColor='white'/>
        <Button text="Suivant" action={handleNextFlashcard} bgColor='dark' textColor='white'/>
      </div>
      <p className='text-xl'>
