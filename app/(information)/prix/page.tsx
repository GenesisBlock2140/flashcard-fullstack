...
export default function Prix () {
  return (
    <>
      ...
      <p className="max-w-[700px] mx-auto my-10">Trouvez l'abonnement qui vous correspond le mieux, pour travailler et apprendre dans des conditions optimales. Il est possible de résilier a tout moment sans justification.</p>
      ...
      <p className="text-sm text-center">*Ce site est en version Beta, <span className="font-semibold">aucun abonnement est fonctionnel</span>.</p>
    </>
  )
}